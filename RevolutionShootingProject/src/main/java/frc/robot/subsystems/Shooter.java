...
public class Shooter extends SubsystemBase {
    ...
    public Shooter() {
        ...
        shooterLeftMotor.configAllowableClosedloopError(Constants.Shooter.PIDLoopIdx, allowableError,
                Constants.Shooter.TimeoutMs);
    ...
    public void periodic() {
        ...
        if ((a != allowableError)) {
            shooterLeftMotor.configAllowableClosedloopError(Constants.Shooter.PIDLoopIdx, (int) Math.round(a),
                    Constants.Shooter.TimeoutMs);
