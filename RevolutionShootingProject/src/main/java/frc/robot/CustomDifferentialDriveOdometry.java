 ...
 */
public class CustomDifferentialDriveOdometry {
     ...
     */
    public CustomDifferentialDriveOdometry(
    ...
    public Pose2d directUpdate(Pose2d newPoseMeeters) {
        m_poseMeters = newPoseMeeters;
        return newPoseMeeters;
    }
}
